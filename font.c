// font.c - Alteo OS 8x16 Bitmap Font (clean, readable)
#include "font.h"
#include "graphics.h"

// 8x16 Font Bitmap Data (ASCII 32-127)
// Each character = 16 bytes, each byte = one row of 8 pixels (MSB first)
